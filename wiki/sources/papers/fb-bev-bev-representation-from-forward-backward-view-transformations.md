...
│  │  (LSS-style)        │  │  (BEVFormer-style)  │              │
│  │                     │  │                     │              │
│  │  Predict depth dist │  │  BEV queries        │              │
│  │  per pixel          │  │  ──► 3D ref points  │              │
│  │  ▼                  │  │  ──► project to img  │              │
│  │  Outer product      │  │  ▼                  │              │
│  │  (depth x feature)  │  │  Deformable         │              │
│  │  ▼                  │  │  Cross-Attention     │              │
│  │  Pillar pooling     │  │  + Temporal          │              │
│  │  onto BEV grid      │  │  Self-Attention      │              │
│  │                     │  │                     │              │
│  │  ──► B_fwd          │  │  ──► B_bwd          │              │
│  └──────────┬──────────┘  └──────────┬──────────┘              │
│             │                        │                          │
